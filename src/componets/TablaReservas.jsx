...
const TablaReservas = () => {
    ...
    const columns = React.useMemo(
        () => [
            ...
            {
                Header: "Codigo auditorio",
                accessor: "codigo_auditorio",
            },
            {
                Header: "Cedula conferencista",
                accessor: "cedula",
            },
            {
                Header: "Descripción",
            ...
            {
                Header: "Nombre auditorio",
                accessor: "nombre_auditorio",
            },
            {
                Header: "Nombre Conferencista",
                accessor: "nombre_conferencista",
            },
            {
                Header: "Actions",
                accessor: "acciones",
